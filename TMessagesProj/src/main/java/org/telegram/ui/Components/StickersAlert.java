...
public class StickersAlert extends BottomSheet implements NotificationCenter.NotificationCenterDelegate {
    ...
    public interface StickersAlertDelegate {
        void onStickerSelected(TLRPC.Document sticker, org.telegram.ui.Components.Rect stickerRect, String query, Object parent, boolean clearsInputField, boolean notify, int scheduleDate);
        boolean canSchedule();
    ...
    private ContentPreviewViewer.ContentPreviewViewerDelegate previewDelegate = new ContentPreviewViewer.ContentPreviewViewerDelegate() {
        ...
        public void sendSticker(TLRPC.Document sticker, String query, Object parent, boolean notify, int scheduleDate) {
            ...
            delegate.onStickerSelected(sticker, null, query, parent, clearsInputField, notify, scheduleDate);
            dismiss();
        }
    ...
    private void init(Context context) {
        ...
        previewSendButton.setOnClickListener(v -> {
            delegate.onStickerSelected(selectedSticker, null, null, stickerSet, clearsInputField, true, 0);
            dismiss();
        });
